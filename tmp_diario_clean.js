...
window.Toolbar.print = ()=> {
  ...
  window.open('index.php?route=api/contabilidad_diario_export_pdf&'+null,'_blank');
};
window.Toolbar.search = ()=> {
  window.location.href='index.php?route=contabilidad/diario/buscar&'+null;
};
window.Toolbar.verify = ()=> {
  window.location.href='index.php?route=contabilidad/diario/verificar';
};
window.Toolbar.export = ()=> {
  window.open('index.php?route=api/contabilidad_diario_export_excel&'+null,'_blank');
};
